...
/**
 * Anything in this file has a mention or link to http://anonym.to/?http://www.interspire.com.
...
defined('LNG_ApplicationTitle') or define('LNG_ApplicationTitle', 'E-Mail Marketer');
...
define('LNG_SMTPCOM_Explain', '
	<a href="http://interspire.smtp.com/" target="_blank" border="0"><img src="images/smtp_com_logo.gif" border="0" /></a>
...
define('LNG_UpgradeMeLK', ' (<a href="http://anonym.to/?http://www.interspire.com/emailmarketer/" target="_blank">Upgrade</a>)');
define('LNG_ApplicationTitleEdition', ' (%s Edition)');
define('LNG_SendingSystem', LNG_ApplicationTitle);
define('LNG_UrlPF_Intro', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYou\'re on day %s of your %s day free trial. <a href="http://anonym.to/?http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlPF_ExtraIntro', ' During the trial, you can send up to %s emails. ');
define('LNG_UrlPF_Intro_Done', 'You\'re currently running a free trial of '.LNG_ApplicationTitle.'.%sYour license key expired %s days ago. <a href="http://anonym.to/?http://www.interspire.com/emailmarketer/pricing.php" target="_blank">Click here to learn about upgrading</a>.');
define('LNG_UrlP', '');
		...
		<tr align="center">
			<td>
				<table bgcolor="white" width="450" border="0" cellpadding="5">
					<tr>
						<td>
							<a href="http://anonym.to/?http://www.interspire.com/emailmarketer/?campaign_email">
...
define('LNG_Form_Branding', '<span style="display: block; font-size: 10px; color: gray; padding-top: 5px;"><a href="http://anonym.to/?http://www.interspire.com/emailmarketer" target="__blank" style="font-size:10px;color:gray;">Email marketing</a> by Interspire</span>');
 ...
 **************************
 */
defined('LNG_Copyright') or define('LNG_Copyright', 'Powered by E-Mail Marketer');
...
defined('SHOW_SMTP_COM_OPTION') or define('SHOW_SMTP_COM_OPTION', false);
