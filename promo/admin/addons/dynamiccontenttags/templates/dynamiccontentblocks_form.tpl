...
<form name="frmDynamicContentBlocks" id="frmDynamicContentBlocks" method="post" action="{$AdminUrl}&Action={if $FormType == 'create'}Create{elseif $FormType == 'edit'}Edit&id={$DynamicContentBlockId}{/if}">
